...
def login_and_create_session(url="https://api.polyground.info/v1/auth/login", id="admin", pw="admin1234"):
...
def reissue(session, url="https://api.polyground.info/v1/auth/reissue"):
    """
    세션으로 토큰 재발급 요청.
...
@reissue_decorator
def get_resource_content_public(session, resource_id, url="https://api.play.polyground.ai/v1/resource/public"):
    """
...
@reissue_decorator
def upload_resource_public(session, name, file_buffer, mime_type="image/jpeg", url="https://api.play.polyground.ai/v1/resource/public"):
    """
